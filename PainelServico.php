...
$sql = "SELECT * FROM pedidos WHERE status = \"Em serviço\"";
	...
	<div class="limiter">
		<div class="container-table100">
			<div class="wrap-table100">
				<div class="table100">
			<form method="post" action="mudarStatus.php" >
				<h3 style="color: blue; ">Mudar Status</h3><br>
					 ...
					 <table>
						...
						<tbody>
								<tr>
									...
									<td class="column4">'.$_SESSION["servico"] = $linha['servico'].'</td>
